...
# Binaries
all: write_blocks_seq read_ram_seq disk_sort distribution true_friend celebrities
...
clean:  
	rm write_blocks_seq disk_sort sorted_list*.dat records_sorted*.dat read_ram_seq distribution edges_sorted_uid2.csv true_friend celebrities in_degree.dat out_degree.dat true_friends.dat
